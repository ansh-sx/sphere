...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    const savedAgeVerified = localStorage.getItem('sphere_age_verified')

    if (savedUsername) setUsername(savedUsername)
    if (savedGradient) setUserGradient(savedGradient)
    if (savedAgeVerified === 'true') setIsAgeVerified(true)
  }, [])
